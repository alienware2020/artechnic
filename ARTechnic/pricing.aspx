                                            ...
                                            <div class="price_container">
                                                <div class="price_box">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <div class="checkboxResponsive">
                                                            <input type="checkbox" id="chkStaticStandardResponsive" /><label for="chkStaticStandardResponsive">Responsive Design</label></div>
                                                        </li>
                                                    </ul>
                                                    <div class="footer">
                                                        <p class="perspective">
                                            ...
                                            <div class="price_container">
                                                <div class="price_box">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <div class="checkboxResponsive">
                                                            <input type="checkbox" id="chkStaticPremiumResponsive" /><label for="chkStaticPremiumResponsive">Responsive Design</label></div>
                                                        </li>
                                                    </ul>
                                                    <div class="footer">
                                                        <p class="perspective">
